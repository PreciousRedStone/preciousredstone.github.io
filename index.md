...
<div id="gallery" class="gallery">
  ...
  {% for art in artWork %}
    <div class="gallery_image_holder js-lazy-load" title="{{ art.basename }}" data-src="{{ art.path | prepend: site.url }}" style="background-image: url({{ art.path | prepend: site.url }})"></div>
  {% endfor %}
